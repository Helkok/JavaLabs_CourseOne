...
public class Main {
    public static void main(String[] args)  {
        ...
        saveCollection("/Users/alexander/eclipse-workspace/lab8/src/lab8/Lab5/ReportCollection.bin", collection);
        Collection collection1 = getCollection("/Users/alexander/eclipse-workspace/lab8/src/lab8/Lab5/ReportCollection.bin");
    ...
    public static void saveCollection(String fileName, Collection saveCollection){
        try(ObjectOutputStream objectOutputStream = new ObjectOutputStream(new FileOutputStream(fileName))){
            objectOutputStream.writeObject(saveCollection);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
