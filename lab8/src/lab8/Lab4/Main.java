...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        CollectionReport collectionReport = new CollectionReport(collection);
        String filePath = "\\Users\\alexander\\eclipse-workspace\\lab8\\src\\lab8\\Lab4\\Report.txt";

        collectionReport.createAndSaveReport(filePath);
        String report = collectionReport.loadReport(filePath);
        System.out.println("\n\n\n" + report);
